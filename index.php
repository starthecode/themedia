  ...
  <section class="bg0">
  			<div class="row m-rl-0 justify-content-center">
  				<div class="col-md-4 p-rl-1 p-b-2">
  					<div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(<?php echo get_template_directory_uri().'/images/post-01.jpg' ?>);">
  				...
  				<div class="col-md-4 p-rl-1 p-b-2">
  					<div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(<?php echo get_template_directory_uri().'/images/post-19.jpg' ?>);">
  						<a href="blog-detail-02.html" class="dis-block how1-child1 trans-03"></a>
  				...
  				<div class="col-md-4 p-rl-1 p-b-2">
  					<div class="bg-img1 size-a-11 how1 pos-relative" style="background-image: url(<?php echo get_template_directory_uri().'/images/post-20.jpg' ?>);">
  						<a href="blog-detail-02.html" class="dis-block how1-child1 trans-03"></a>
